...
def get_evals(evals,nbands,nbands_valence, set_gap = None, set_direct_gap = None):
    """
    ...
    value for the gap (direct or indirect). Implemented only for semiconductors.
    ...
    Args:
        ...
        set_direct_gap (:py:class:`float`) : set the value of the direct gap (in eV) of the system. If set_gap
...
def get_transitions(evals, nbands, nbands_valence, initial = 'full', final = 'empty',set_gap = None, set_direct_gap = None):
    """
    ...
    if final == 'full':
        ...
        fin_list = final
    evals = get_evals(evals,nbands,nbands_valence,set_gap=set_gap,set_direct_gap=set_direct_gap)
    transitions = []
    for bands in evals:
