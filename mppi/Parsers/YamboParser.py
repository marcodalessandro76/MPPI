...
def eval_columns(lines):
    ...
    its elements to float. Then transpose the array so that each element
    is a column of the data of the file.
    """
    splitted = []
...
def make_dict(columns,suffix):
    ...
    reference_column_names attribute to the keys the associated names
    """
    data = {}
