"""
This module is the old implementation of the QeCalculator class and will be removed
...
class QeCalculatorSingleTask(Runner):
    """
    ...
    def __init__(self, isParallel = False,
